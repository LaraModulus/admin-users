...
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-xs-6">
                <form action="{{route('admin.users.form', ['id' => $user->id])}}" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="" value="{{old('email', $user->email)}}" required>
                    </div>
